...
@router.get("/{id_book}/authors", tags=["Books Interactions"], status_code=status.HTTP_200_OK)
...
@router.get("/{id_book}/loans", tags=["Books Interactions"], status_code=status.HTTP_200_OK)
